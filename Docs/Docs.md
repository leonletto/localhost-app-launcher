...
Description automatically generated](images/RegistryScreenshot.png)

This is configured through the PowerShell sensor here.

![A computer screen shot of a program
Description automatically generated](images/image002.png)

Then you need to add a Web clip in either Workspace ONE UEM or in Workspace ONE Access to point to [https://localhost.com/notepad](https://localhost.com/notepad)
...
With these steps, you've successfully configured LHLauncher to launch Notepad.exe and verified its process. You can follow similar procedures to configure LHLauncher for other applications as well.
...
![A screenshot of a computer
Description automatically generated](images/image003.png)

![A screenshot of a computer
Description automatically generated](images/image004.png)

![A screenshot of a computer
Description automatically generated](images/image005.png)

![A screenshot of a computer
Description automatically generated](images/image006.png)
...
Description automatically generated](images/image007.png)

Copy the IdentifyingNumber and input it as the criteria.

![A screenshot of a computer
Description automatically generated](images/image008.png)

Then click Add.

![A blue and white box with text
Description automatically generated](images/image009.png)
...
![A screenshot of a computer
Description automatically generated](images/image010.png)
...
Description automatically generated](images/image012.png)

The Execution context should be Current User

![A screenshot of a computer program
Description automatically generated](images/image013.png)
...
![A screenshot of a computer program
Description automatically generated](images/image014.png)

The next section to configure is the URL to your Workspace ONE Access App Catalog:

![](images/image015.png)

The default logging path is C:\\ProgramData\\LHLauncher. You can change that if you like: ![](images/image016.png)
...
![A screenshot of a computer
Description automatically generated](images/image017.png)
...
![A screenshot of a computer
Description automatically generated](images/image018.png)
